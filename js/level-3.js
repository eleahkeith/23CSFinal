...
const quiz = {
  ...
  q2: {q: "function runUp(steps) {...}; function runDown(steps) {...}; function runRight(steps) {...}; function runLeft(steps) {...};",
  ...
  q3a: {q: "var i = 0; while (i < number) {runUpOneStep(); i++}; runRight(2);",
        a1: ["number = 9", false],
        a2: ["number = 10", false],
        a3: ["number = 11", true],
        a4: ["number = 12", false]},
  q3b: {q: "function path() {walk(2,'right');",
  ...
  q5: {q: "walk(2, 'right'); <br> var options = {number: [1, 2, 3], direction: ['up', 'down', 'right']};",
  ...
  q6a: {q: "var steps = [1, 3]; steps.push(2);",
  ...
  q6b: {q: "for (var i = 10; i > number; i--) {runUpOneStep();};",
        a1: ["number = 3", false],
        a2: ["number = 4", true],
        a3: ["number = 5", false],
        a4: ["number = 6", false]},
  q7a: {q: "runRight(2); for (var i=10; i > number; i--) {runUpOneStep();}; runRight(1);",
        a1: ["number = 3", false],
        a2: ["number = 4", false],
        a3: ["number = 5", true],
        a4: ["number = 6", false]},
  q7b: {q: "runRight(1); runUp(1); var steps = [1, 3, 4, 2]; steps.splice(2, 1);",
  ...
  q8: {q: "var riverWidth = 1; var riverDepth = 'deep'; <br> if (condition) {buildBridge();} else {goHome();};",
  ...
  q9: {q: "var bridgeExists = true; if (condition) {goHome();} else {crossBridge();}",
  ...
  q10a: {q: "function runToExit(a, b, c) {runRight(a); runUp(b); runRight(c);};",
        a1: ["runToExit(1, 2, 1);", true],
        a2: ["runToExit(b = 2, a = 1, c = 1);", false],
        a3: ["var a = 1; var b = 2; var c = 1; runToExit();", false],
        a4: ["runToExit(1; 2; 1);", false]},
  q10b: {q: "function runToExit(a, b, c) {runRight(a); runDown(b); runRight(c);};",
